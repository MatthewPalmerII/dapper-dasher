...
int main()
{
    ...
    // nebula variables
    Texture2D nebula = LoadTexture("textures/12_nebula_spritesheet.png"); // load a nebula from the texture folder
    ...
    // scarfy variables
    Texture2D scarfy = LoadTexture("textures/scarfy.png"); // load scrafy from the texture folder
    AnimData scarfyData;
